    ...
    return (
      <div className="container">
        ...
        <div className="position-entry-images__wrapper">
          <div className="position-entry-images__image-container">
            ...
            <a href="#tf1">
              <img
                src={this.state.tf1}
                className="position-entry-images__image"
                alt="entry "
              ></img>
            </a>
          </div>
          <a href="#" id="tf1" className="position-entry__lightbox">
            <img
              className="position-entry__lightbox-image"
              src={this.state.tf1}
              alt="entry "
            ></img>
          </a>
        ...
        <div className="position-information__wrapper">
          <h3 className="position-information__title-entry">
          ...
          <Link
            exact="true"
            to={{
              pathname: `/position/${this.state._id}/edit/`,
              state: this.state,
            }}
          >
            <button>Edit</button>
